 ...
 * - 싱글톤(Singleton) 패턴을 사용하여 **모든 씬에서 변수를 공유**할 수 있도록 설계되었습니다.
 *
 * 🛠️ **주요 기능:**
 * 1️⃣ **변수 저장 및 관리**
 ...
 *
 * 3️⃣ **싱글톤 패턴 적용**
 *    - **VariableManager는 게임 내에서 하나의 인스턴스만 존재하도록 설계**되었습니다.
 *    - Awake()에서 **이미 존재하는 인스턴스가 있으면 새로 생성하지 않고 기존 인스턴스를 유지**합니다.
